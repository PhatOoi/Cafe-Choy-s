        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="user-cell">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background={{ $user->role_id === 1 ? 'd97706' : ($user->role_id === 2 ? '2563eb' : '16a34a') }}&color=fff&size=72"
                    ...
                    <td>
                        <span class="badge {{ $user->role_id === 1 ? 'badge-admin' : ($user->role_id === 2 ? 'badge-staff' : 'badge-customer') }}">
