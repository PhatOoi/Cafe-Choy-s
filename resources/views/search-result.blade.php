...
<head>
    ...
    <title>Kết quả tìm kiếm "{{ $q }}" — Choy's Cafe</title>
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            ...
            <div class="search-bar"> <form action="{{ url('/search') }}" method="GET" class="search-bar-inner" style="width:100%; display:flex;"> 
                <input type="text" class="search-bar-input" name="q" placeholder="Tìm món yêu thích..." value="{{ $q ?? '' }}" autocomplete="off">
                 <button type="submit" class="search-bar-mic" aria-label="Tìm kiếm"> <span class="icon icon-search"></span> </button> </form> </div>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <h2 class="footer-logo">Choy's Cafe</h2>
...
@keyframes fadeIn {
    ...
    to {
        ...
        *::after {
        ...
        .menu-section { background: #f5f0eb; padding: 56px 24px 80px; min-height: 60vh; } .menu-category-title { border-bottom: 2px solid #c8b8a8; margin-top: 40px; margin-bottom: 30px; padding-bottom: 8px; color: #1a110d; font-family: 'Playfair Display', serif; font-size: 2rem; }
</style>
