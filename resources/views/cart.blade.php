...
<body>
    ...
    {{-- ── Phần chính giỏ hàng: bảng item + block thanh toán ── --}}
        ...
        <div class="container cart-section-container">
			<div class="row justify-content-center">
                <div class="col-lg-12 cart-page-wrap">
                    ...
                    {{-- Dialog cảnh báo khi số lượng sản phẩm vượt quá giới hạn cho phép. --}}
                        ...
                        <div class="row mt-5" id="cart-summary-section">
							<div class="col-md-6 offset-md-6">
								<div class="card">
                                    ...
                                    // Dùng dialog tùy biến để cảnh báo vượt số lượng đồng bộ với giao diện web.
